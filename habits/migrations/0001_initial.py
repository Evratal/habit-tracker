    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.PositiveIntegerField(choices=[(1, 'Ежедневно'), (7, 'Еженедельно')], default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(7)], verbose_name='Периодичность (дни)')),
